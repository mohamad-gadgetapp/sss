...
const TradeBlotter = () => {
  ...
  let localData: any = localStorage.getItem("rowData");
            ...
            <div className="date-table-div">
              <table className="date-table-style">
                <tbody>
                  ...
                  <tr>
                    <td className="securityInfo-table-data-cell">151</td>
                    <td className="securityInfo-table-data-cell">98463</td>
                    <td className="securityInfo-table-data-cell">SSS</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="date-table-style">
                <tbody>
                  <tr>
                    ...
                    <td className="securityInfo-table-data-cell">Symbol</td>
                  </tr>
                  <tr>
                    <td className="securityInfo-table-data-cell">151</td>
                    <td className="securityInfo-table-data-cell">98463</td>
